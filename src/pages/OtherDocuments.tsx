...
export default function OtherDocuments() {
  ...
  const uploadDoc = async () => {
    ...
    const file_url = `${import.meta.env.VITE_SUPABASE_URL}/storage/v1/object/public/other_docs/${filePath}`;
  ...
  const deleteDocument = async (doc: any) => {
    ...
    await supabase.storage.from("other_docs").remove([doc.file_path]);
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-blue-600 mb-6">Other Documents</h1>
      ...
      <div className="bg-white p-6 shadow rounded-lg">
        ...
        <input
          ...
          placeholder="Example: Miscellaneous Document"
        />
